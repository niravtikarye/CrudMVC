...
<div class="insta-card">
    ...
    <div class="insta-actions">
        ...
        <div title="assign" class="assign-icon" onclick="assignProblem(this, '${problem.probId}')" style="cursor:pointer;">
    ...
    <div class="resolution-actions" style="margin: 10px 15px; padding-bottom: 10px;">
        <c:set var="userRole" value="${sessionScope.loggedInUser != null ? sessionScope.loggedInUser.role : ''}" />
